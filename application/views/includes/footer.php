...
<!--embedded css to fixed footer at bottom-->
<!--<style>-->
<!--    #footer {-->
<!--        position: fixed;-->
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="footer-copy-right">
                    <p>Developed by S.Heshan (BIT PROJECT - R171843). Ver 1.0</p>
                </div>
            </div>
        </div>
    </div>
...
<!--  todo JS
    ============================================ -->
<script src="<?php echo base_url(); ?>assets/js/customJs/todo.js"></script>
