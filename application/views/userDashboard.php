    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                    ...
                    <div class="website-traffic-ctn">
                        <h2><span class="counter" style="color: red;"><?php echo $casApdCnt->apdCount; ?></span><span> Out of </span><span
                                    class="counter"><?php echo $casApdCnt->aplyCount; ?></span></h2>
                        <p>Total Casual Leaves Approved</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        <h2><span class="counter" style="color: red;"><?php echo $rstApdCnt->apdCount; ?></span><span> Out of </span><span
                                    class="counter"><?php echo $rstApdCnt->aplyCount; ?></span></h2>
                        <p>Total Rest Leaves Approved</p>
                    </div>
                ...
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        <h2><span class="counter"
                                  style="color: red;"><?php echo $LastrstApdCnt->apdCount; ?></span><span> Out of </span><span
                                    class="counter"><?php echo $LastrstApdCnt->aplyCount; ?></span></h2>
                        <p>Total Last Rest Leaves Approved</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        <h2><span class="counter"
                                  style="color: red;"><?php echo $TotDoneTasks->totDoneCnt; ?></span><span> Out of </span><span
                                    class="counter"><?php echo $TotTasks->totTskCnt; ?></span></h2>
                        <p>Total Works Done By You</p>
                    </div>
...
<!--                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">-->
                            ...
                            <div class="normal-table-list mg-t-30">
                                <div class="basic-tb-hd">
                                    <h4 style="text-transform: uppercase; color: #666666; ">Latest Leave
                                        Summary</h4>
                                </div>
                                ...
                                <div class="bsc-tbl-st">
                                    <table class="table table-striped">
                                        ...
                                        <?php if ($LvSummary != null) { ?>

                                            <?php $count = 1; ?>

                                            <?php foreach ($LvSummary as $all) { ?>
