...
<head>
    <title>Work Summary | Survey - Elms</title>
    <!-- favicon
		============================================ -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="data-table-list">
                    <div class="basic-tb-hd">
                        <h4 style="text-transform: uppercase; color: #666666; ">Tasks Summary</h4>
                    </div>
                    <div class="table-responsive">
                        <table id="data-table-basic" class="table table-striped">
                            ...
                            <?php if ($allTasks != null) {
                                $count = 1;
                                ?>
                                <?php foreach ($allTasks as $alTsk) { ?>

                                    <tr>
                                        <td><?php echo $count; ?></td>
                                        <td><?php echo $alTsk['workName']; ?></td>
                                        <td><?php echo $alTsk['assignDisc']; ?></td>
                                        <td><?php echo $alTsk['deadline']; ?></td>
                                        <td>
                                            <?php if ($alTsk['priorityLevel'] == 1) { ?>
                                                <span style="color: red">High</span>

                                            <?php }
                                            if ($alTsk['priorityLevel'] == 2) { ?>
                                                <span style="color: green">Medium</span>

                                            <?php }
                                            if ($alTsk['priorityLevel'] == 3) { ?>
                                        ...
                                        <td>
                                            <?php if ($alTsk['worStage'] == 0) { ?>
                                                <span style="color: black">Not Accepted</span>

                                            <?php } ?>
                                            <?php if ($alTsk['worStage'] == 1) { ?>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>index.php/work_assign_control/task_details_controller/taskDetailsView?taskId=<?php echo $alTsk['workId']; ?>">
