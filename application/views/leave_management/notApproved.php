...
<head>
    <title>Not Approved Leave | Survey - Elms</title>
    <!-- favicon
		============================================ -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="data-table-list">
                    <div class="basic-tb-hd">
                        <h4 style="text-transform: uppercase; color: #666666; ">Not Approved Leave Applications</h4>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table id="data-table-basic" class="table table-striped">
                            ...
                            <?php if ($lvs != null) { ?>
                                ...
                                <?php foreach ($lvs as $notApd) { ?>

                                    <tr>
                                        <td><?php echo $count; ?></td>
                                        <td><span style="color: #0277CA; font-size:16px;"><b><?php echo $notApd['fName'] . " " . $notApd['lName'] ?> </br>
                                                    (<?php echo $notApd['empNo'] ?>)</b></span></td>
                                        <td><?php echo $notApd['levName']; ?></td>
                                        <td><?php echo $notApd['applyDate']; ?></td>

                                        <td>
                                            <?php if ($notApd['status'] == 1) { ?>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>index.php/leave_mgt_control/leave_dtl_controller/detailsView?leaveid=<?php echo $notApd['id']; ?>">
