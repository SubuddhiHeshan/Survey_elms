...
<head>
    <title>Pending Leave | Survey - Elms</title>
    <!-- favicon
		============================================ -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="data-table-list">
                    <div class="basic-tb-hd">
                        <h4 style="text-transform: uppercase; color: #666666; ">Pending Leave Applications</h4>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table id="data-table-basic" class="table table-striped">
                            ...
                            <?php if ($lvs != null) { ?>
                                ...
                                <?php foreach ($lvs as $pend) { ?>

                                    <tr>
                                        <td><?php echo $count; ?></td>
                                        <td><span style="color: #0277CA; font-size:16px;"><b><?php echo $pend['fName'] . " " . $pend['lName'] ?> </br>
                                                    (<?php echo $pend['empNo'] ?>)</b></span></td>
                                        <td><?php echo $pend['levName']; ?></td>
                                        <td><?php echo $pend['applyDate']; ?></td>

                                        <td>
                                            <?php if ($pend['status'] == 1) { ?>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>index.php/leave_mgt_control/leave_dtl_controller/detailsView?leaveid=<?php echo $pend['id']; ?>&read=1">
