...
<head>
    <title>Approved Leave | Survey - Elms</title>
    <!-- favicon
		============================================ -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="data-table-list">
                    <div class="basic-tb-hd">
                        <h4 style="text-transform: uppercase; color: #666666; ">Approved Leave Applications</h4>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table id="data-table-basic" class="table table-striped">
                            ...
                            <?php if ($lvs != null) { ?>
                                <?php $count = 1; ?>
                                <?php foreach ($lvs as $apd) { ?>

                                    <tr>
                                        <td><?php echo $count; ?></td>
                                        <td><span style="color: #0277CA; font-size:16px;"><b><?php echo $apd['fName'] . " " . $apd['lName'] ?> </br>
                                                    (<?php echo $apd['empNo'] ?>)</b></span></td>
                                        <td><?php echo $apd['levName']; ?></td>
                                        <td><?php echo $apd['applyDate']; ?></td>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>index.php/leave_mgt_control/leave_dtl_controller/detailsView?leaveid=<?php echo $apd['id']; ?>">
