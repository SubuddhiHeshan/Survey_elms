...
class all_leave_model extends CI_Model
{
    private $tbu = 'user';
    private $tlv = 'leaves';
    ...
    public function getLeaves($dept,$ofz)
    {
        //select user . fName, user . lName, leaves . levName, leavehistory . applyDate, leavehistory . status, leavehistory.empNo, leavehistory.id
        //from user
